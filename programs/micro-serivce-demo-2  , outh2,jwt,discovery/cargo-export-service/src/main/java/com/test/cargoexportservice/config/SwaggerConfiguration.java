...
public class SwaggerConfiguration extends WebMvcConfigurationSupport {
	...
	public Docket serviceApi() {
		return new Docket(DocumentationType.SWAGGER_2).securitySchemes(Arrays.asList(securityScheme()))
				...
				.apis(RequestHandlerSelectors.basePackage("com.test.cargomanagementservice.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Cargo management service")
				.description("cargo Api detail").version("1.0.0")
				.contact(new Contact("Cargo Web", "https://www.google.com/", null)).build();
	}
}
